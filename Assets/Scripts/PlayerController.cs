...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] ControllerLook controllerLook;
    ...
    private void FixedUpdate()
    {
        ...
        inputActions.Player.ControllerX.performed += ctx => contInput.x = ctx.ReadValue<float>();
        inputActions.Player.ControllerY.performed += ctx => contInput.y = ctx.ReadValue<float>();
        controllerLook.ReceiveInput(contInput);
